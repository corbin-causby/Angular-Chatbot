...
export class ChatComponent implements OnInit, AfterViewChecked {
  ...
  constructor(private http: HttpClient, private sanitizer: DomSanitizer) {
    ...
    this.apiKey = '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';
  }
  ...
  async sendMessage(){
    ...
    const conversation = [
      { role: 'system', content: 'You are an assistant that assists in health care and can answer questions about health care.' },
